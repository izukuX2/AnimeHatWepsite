...
description: Forks are alternative versions of AnimeHat with exclusive features.
lastUpdated: false
editLink: false
prev: false
next: false
...
features:
  ...
  - title: TachiyomiSY
    details: Keeping up-to-date with AnimeHat while also adding exclusive features
  ...
  - title: Yōkai
    ...
    link: /forks/Yokai/
  - title: Komikku
    details: A fork with features from Sy and AnimeHat plus added personal flair.
...
Forks are alternative versions of AnimeHat with exclusive features.

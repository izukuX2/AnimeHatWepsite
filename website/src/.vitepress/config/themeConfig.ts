...
const themeConfig: DefaultTheme.Config = {
  ...
  socialLinks: [
    {
      icon: 'github',
      link: 'https://github.com/izukuX2/AnimeHat',
      ariaLabel: 'Project GitHub',
    },
    {
      icon: 'discord',
      link: 'https://discord.gg/WmEEQ5Q3e5',
  ...
  footer: {
    ...
    copyright: `Copyright © ${new Date().getFullYear()} AnimeHat`,
  },

  editLink: {
    pattern: 'https://github.com/izukuX2/website/edit/main/website/src/:path',

  ...
  <div>
    <div v-if="!isAndroid">
      ...
      <div class="custom-block warning">
        ...
        <p>
          <strong>AnimeHat</strong> is an <strong>Android app</strong> only.
    ...
    <div v-if="isAndroid">
      <div class="action-buttons">
        <a
          class="action-button primary"
          href="tachiyomi://add-repo?url=https://raw.githubusercontent.com/izukuX2/AnimeHat/main/repo/index.min.json"
      ...
      <span class="version-disclaimer">
        Requires <strong>AnimeHat 3.0</strong> or higher.
      </span>

...
hero:
  name: AnimeHat
  text: The Ultimate Anime Experience
  tagline: Discover and watch anime, cartoon and more – with AI-powered recommendations and adaptive UI.
  image:
    alt: AnimeHat
...
customMetaTitle: AnimeHat

features:
  - title: AI Recommendations
    details: Discover your next favorite series with smart suggestions based on your watch history and preferences.
  ...
  - title: Adaptive UI
    details: Experience a modern interface with Glassmorphism and colors that adapt to the anime you watch.
    icon: <svg height="24" width="24" viewBox="0 -960 960 960" fill="var(--vp-c-indigo-2)" xmlns="http://www.w3.org/2000/svg"><path d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z"/></svg>
  - title: Live Schedule
    details: Stay updated with real-time countdowns for the latest episodes of currently airing series.

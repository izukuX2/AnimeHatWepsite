...
1. **Restart AnimeHat**: Force close and reopen the app.
...
If none of these solutions help, try asking in our [Discord server](https://discord.gg/WmEEQ5Q3e5).
...
## Personalized issue
If you're the only one facing a problem, you might be encountering [Cloudflare](/docs/guides/troubleshooting/#cloudflare) protection, an IP ban, or other countermeasures set by website owners against programs like **AnimeHat**.
...
1. Check [open issues](https://github.com/izukuX2/AnimeHat/issues).
2. Check [closed issues](https://github.com/izukuX2/AnimeHat/issues?q=is%3Aissue+is%3Aclosed) in case it's resolved but not yet released.

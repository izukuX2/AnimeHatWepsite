...
Using non-standard **WebView** (like **Firefox**) might cause **AnimeHat** to malfunction or crash.
...
Some sources intentionally have higher **Cloudflare** protection to deter apps like **AnimeHat**.

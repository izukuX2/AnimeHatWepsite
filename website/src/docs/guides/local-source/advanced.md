...
```
::: tip
You can use any standard JSON editor to create the `details.json` file. Ensure that the field names match the example above for the app to recognize them correctly.
:::

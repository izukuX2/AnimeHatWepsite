...
description: Using Shizuku with AnimeHat.
---

# Shizuku
**Shizuku** is an alternative method for installing and updating extensions in **AnimeHat**.
...
After configuring it, enable **Shizuku** within **AnimeHat** by navigating to <nav to="advanced"> then changing the **Installer** setting.

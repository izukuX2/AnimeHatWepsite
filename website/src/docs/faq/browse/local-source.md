...
## What should I do if I can't find the AnimeHat folder?
In case the **AnimeHat** folder is not visible, create one using a file manager.
...
Related GitHub Issue: [#932](https://github.com/izukuX2/AnimeHat/issues)
